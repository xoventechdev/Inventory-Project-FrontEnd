...
import { ReturnReportRequest } from "../../api_request/ReportApiRequest";
...
const ReturnReport = () => {
  ...
  const report = useSelector((state) => state.report.returnReport);
  ...
  const viewReport = async () => {
    if (fromDate && toDate) {
      await ReturnReportRequest(fromDate, toDate);
    } else {
  ...
  const exportData = (fileType) => {
    const fileName = `Return Report ${today}`;
    ...
    <div className="container-fluid">
            ...
            <div className="card">
              <div className="card-body">
                <div className="row d-flex justify-content-between">
                  <div className="col-md-6 col-lg-6 p-2">
                    <span className="h6">
                      Total Return : {report.total[0].total}
                    </span>
                  </div>
                  <div className="col-md-6 col-lg-6 p-2 text-end">
                    <button
      ...
      <div className="row">
        <div className="col-md-12 p-2">
          <div className="card">
            <div className="card-body">
              <span className="h6">Return of {title}</span>
