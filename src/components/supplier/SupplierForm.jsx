...
const SupplierForm = () => {
  ...
  const formData = useSelector((state) => state.supplier.formValues);
  ...
  const saveTo = () => {
    ...
    if (IsEmpty(name)) {
      ...
      AddSupplier(formData, id).then((res) => {
        if (res == 2) {
          navigate("/supplier");
        }
      });
        ...
        <div className="col-12">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-12">
                  <h5>{id ? "Update Supplier" : "Add Supplier"}</h5>
                  <ToastContainer />
