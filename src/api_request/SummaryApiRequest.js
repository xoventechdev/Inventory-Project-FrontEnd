...
export const ExpenseSummaryRequest = async () => {
  ...
  try {
    ...
    if (data.data.status == "success" && data.data.response.total.length > 0) {
      ReduxStore.dispatch(setExpenseSummary(data.data.response));
    }
  } catch (error) {
    ReduxStore.dispatch(HideLoader());
...
export const PurchaseSummaryRequest = async () => {
  ...
  try {
    ...
    ReduxStore.dispatch(HideLoader());
    if (data.data.status == "success" && data.data.response.total.length > 0) {
      ReduxStore.dispatch(setPurchaseSummary(data.data.response));
    }
  } catch (error) {
    ReduxStore.dispatch(HideLoader());
...
export const SalesSummaryRequest = async () => {
  ...
  try {
    ...
    ReduxStore.dispatch(HideLoader());
    if (data.data.status == "success" && data.data.response.total.length > 0) {
      ReduxStore.dispatch(setSalesSummary(data.data.response));
    }
  } catch (error) {
    ReduxStore.dispatch(HideLoader());
...
export const ReturnSummaryRequest = async () => {
  ...
  try {
    ...
    ReduxStore.dispatch(HideLoader());
    if (data.data.status == "success" && data.data.response.total.length > 0) {
      ReduxStore.dispatch(setReturnSummary(data.data.response));
    }
  } catch (error) {
    ReduxStore.dispatch(HideLoader());
