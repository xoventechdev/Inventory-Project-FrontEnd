    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route exact path="/expense/edit/:id" element={<ExpenseFormPage />} />
          <Route exact path="/expenseType" element={<ExpenseTypeListPage />} />
          <Route
            exact
          ...
          <Route exact path="/product/edit/:id" element={<ProductFormPage />} />
          ...
          />
          <Route exact path="/report/expense" element={<ExpenseReportPage />} />
          ...
          <Route
            exact
            path="/verify-otp"
            element={<VerifyPasswordRequestPage />}
          />
